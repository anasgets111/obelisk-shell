//! Pure connection-intent helpers for `obelisk.network`: join verdicts, profile settings,
//! NetworkManager dict construction, and write-command arg parsers; see `network/mod.rs` for the
