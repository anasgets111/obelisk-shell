...
-- GENERATED by `supervisor/src/stubs.rs`. Do not edit: run
...
mod tests {
    ...
    fn the_generated_stub_matches_what_is_checked_in() {
        ...
        assert_eq!(current, rendered, "lua-meta/oblisk.lua is stale. Rerun with UPDATE_STUBS=1 and commit the result.");
    }
