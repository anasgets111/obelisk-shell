...
-- `obelisk.polkit` registers this shell as the session agent (ADR-0070).
--
...
local function read(fn)
    return util.label(obelisk.polkit, fn)
end

local active = util.shown_when(obelisk.polkit, function(p)
    return p.active
end)
        ...
        children = {
            panel_card({
                ...
                cell(read(function(p)
                    ...
                    width = "Fill",
                    visible = util.shown_when(obelisk.polkit, function(p)
