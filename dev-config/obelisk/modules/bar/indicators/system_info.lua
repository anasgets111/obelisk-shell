...
local function tint(field, fallback)
    return obelisk.sysinfo:map(function(s)
    ...
    return tile {
        row {
            ...
            children = {
                ...
                cell(util.label(obelisk.sysinfo, function(s)
        ...
        meter(obelisk.sysinfo, function(s)
...
local function summary_readout(label, field, accent)
    return cell(util.label(obelisk.sysinfo, function(s)
    ...
    local details = column {
        ...
        children = {
            row {
                ...
                spacing = theme.spacing.sm,
                children = {
                    metric_tile(icons.cpu, "CPU", "cpu_percent", theme.ACCENT, util.label(obelisk.sysinfo, function(s)
            ...
            tile({ row {
                ...
                children = {
                    ...
                    end), obelisk.sysinfo:map(function(s)
                ...
                visible = util.shown_when(obelisk.sysinfo, function(s)
