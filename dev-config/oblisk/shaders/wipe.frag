...
//
// The engine has already fitted both pictures and hands them back through `oblisk_from`/
// `oblisk_to`, so none of the reference's `sampleWithFillMode` prelude is needed here.
//
